...
public class WebScreenshotUtils {
    ...
    private static WebDriver initChromeDriver(int width, int height) {
        try {
            ...
            log.error("初始化ChromeDriver失败: {}", e.getMessage());
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "初始化Chrome 浏览器失败");
        }
