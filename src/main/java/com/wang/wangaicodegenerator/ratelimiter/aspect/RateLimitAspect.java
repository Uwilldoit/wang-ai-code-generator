package com.wang.wangaicodegenerator.ratelimiter.aspect;
...
public class RateLimitAspect {
    ...
    /**
     * 在标注了@RateLimit 注解的方法执行前进行拦截，生成限流key获取Redisson 限流器，并设置限流规则
     * @param point
     * @param rateLimit
     */
    ...
    /**
     * 根据不同的限流策略生成唯一的 Redis key， API级别按方法名、用户级别按用户ID、IP级别用客户端IP，从而支持三种限流维度
     * @param point 切入点
